...
const EDUCATION = [
  { icon: Award, title: "Front-End Development Certificates", org: "Azubi Africa, HerTechTrail" },
  { icon: Award, title: "MERN Full Stack Development", org: "MEST Africa" },
  { icon: GraduationCap, title: "BSc Home Science (Consumer Science)", org: "University of Ghana" },
];
  ...
  return (
    <AnimatedSection id="education" className="py-20 md:py-28">
      <div className="container mx-auto px-4 md:px-8 max-w-3xl">
        ...
        <h3 className="text-3xl md:text-4xl font-bold mb-12 text-foreground">Certifications & Degrees</h3>
